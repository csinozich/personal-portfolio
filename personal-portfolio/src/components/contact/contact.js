  ...
  return (
    <div className='contact'>
      <div className='contact-info'>
        <img className='reach' src='https://live.staticflickr.com/65535/46946199734_c0779506e6.jpg' />
      ...
      <div className='contact-sites'>
        <img className='find' src="https://live.staticflickr.com/65535/33792951298_1d041017dc.jpg"/>
        <p className='find-link'><a href=''>GitHub</a></p>
